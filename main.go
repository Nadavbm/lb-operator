...
import (
	...
	servicesv1alpha1 "example.com/lb/apis/services/v1alpha1"
	configmapscontrollers "example.com/lb/controllers/configmaps"
	deploymentscontrollers "example.com/lb/controllers/deployments"
	servicescontrollers "example.com/lb/controllers/services"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "442b5ae5.example.com",
